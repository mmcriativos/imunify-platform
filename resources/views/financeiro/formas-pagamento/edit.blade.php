...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Atualize as informações da forma de pagamento</p>
    </div>

    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('financeiro.formas-pagamento.update', $formaPagamento) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    @foreach($tipos as $value => $info)
                        <label class="cursor-pointer">
                            <input 
                                ...
                                name="tipo" 
                                value="{{ $value }}" 
                                {{ old('tipo', $formaPagamento->tipo) == $value ? 'checked' : '' }}
                                class="peer sr-only" 
                                required
                            >
                ...
                <div>
                    ...
                    <div class="relative">
                        <input 
                            ...
                            id="taxa_percentual"
                            value="{{ old('taxa_percentual', $formaPagamento->taxa_percentual) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input 
                            ...
                            value="{{ old('prazo_recebimento', $formaPagamento->prazo_recebimento) }}"
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    name="adquirente" 
                    id="adquirente"
                    value="{{ old('adquirente', $formaPagamento->adquirente) }}"
            ...
            <div class="mb-6 space-y-3">
                <label class="flex items-start gap-3 cursor-pointer">
                    <input 
                        ...
                        value="1"
                        {{ old('requer_conciliacao', $formaPagamento->requer_conciliacao) ? 'checked' : '' }}
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">Marque se precisa conciliar com extrato da operadora</p>
                    </div>
                </label>
                ...
                <label class="flex items-start gap-3 cursor-pointer">
                    <input 
                        ...
                        name="ativo" 
                        value="1"
                        {{ old('ativo', $formaPagamento->ativo) ? 'checked' : '' }}
                        class="mt-1 w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                    >
                    <div>
                        <span class="text-sm font-semibold text-gray-700">Forma de Pagamento Ativa</span>
